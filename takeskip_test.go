...
func Test_Take_int(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got, _ := Take(tt.args.source, tt.args.count); !SequenceEqualMust(got, tt.want) {
				got.Reset()
				tt.want.Reset()
...
func Test_TakeWhile_string(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got, _ := TakeWhile(tt.args.source, tt.args.predicate); !SequenceEqualMust(got, tt.want) {
				got.Reset()
				tt.want.Reset()
...
func Test_TakeWhileIdx_string(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got, _ := TakeWhileIdx(tt.args.source, tt.args.predicate); !SequenceEqualMust(got, tt.want) {
				got.Reset()
				tt.want.Reset()
...
func Test_Skip_int(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got, _ := Skip(tt.args.source, tt.args.count); !SequenceEqualMust(got, tt.want) {
				got.Reset()
				tt.want.Reset()
...
func Test_SkipWhile_string(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got, _ := SkipWhile(tt.args.source, tt.args.predicate); !SequenceEqualMust(got, tt.want) {
				got.Reset()
				tt.want.Reset()
...
func Test_SkipWhileIdx_string(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got, _ := SkipWhileIdx(tt.args.source, tt.args.predicate); !SequenceEqualMust(got, tt.want) {
				got.Reset()
				tt.want.Reset()
