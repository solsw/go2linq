...
func main() {
	store1 := go2linq.NewEnSlice(ProductA{Name: "apple", Code: 9}, ProductA{Name: "orange", Code: 4})
	store2 := go2linq.NewEnSlice(ProductA{Name: "apple", Code: 9}, ProductA{Name: "lemon", Code: 12})
