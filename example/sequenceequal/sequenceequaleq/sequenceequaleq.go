...
func main() {
	storeA := go2linq.NewOnSliceEn(
		Product{Name: "apple", Code: 9},
		Product{Name: "orange", Code: 4},
	)
	storeB := go2linq.NewOnSliceEn(
		Product{Name: "apple", Code: 9},
		Product{Name: "orange", Code: 4},
	)
	equalAB := go2linq.SequenceEqualEqMust(storeA, storeB,
		go2linq.Equaler[Product](go2linq.EqualerFunc[Product](func(p1, p2 Product) bool { return p1.Code == p2.Code && p1.Name == p2.Name })),
	)
	fmt.Printf("Equal? %t\n", equalAB)
}
