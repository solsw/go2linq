...
func Test_SumInt_string(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := SumInt(tt.args.source, tt.args.selector); got != tt.want {
...
func Test_SumFloat64_string(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := SumFloat64(tt.args.source, tt.args.selector); got != tt.want {
...
func Test_SumFloat64IsNaN_string(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if want := math.IsNaN(SumFloat64(tt.args.source, tt.args.selector)); want != tt.want {
				t.Errorf("IsNaN(SumFloat64()) = %v, want %v", want, tt.want)
			}
		})
	}
}
...
func Test_SumFloat64IsInf_float64(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := SumFloat64(tt.args.source, tt.args.selector)
			var want bool
			switch tt.name {
			...
			if want != tt.want {
				t.Errorf("IsInf(SumFloat64()) = %v, want %v", want, tt.want)
			}
		})
	}
}
...
func Test_AverageIntErr_int(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := AverageIntErr(tt.args.source, tt.args.selector)
			if (err != nil) != tt.wantErr {
				t.Errorf("AverageIntErr() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if tt.wantErr {
				if err != tt.expectedErr {
					t.Errorf("AverageIntErr() error = %v, expectedErr %v", err, tt.expectedErr)
				}
				return
			}
			if got != tt.want {
				t.Errorf("AverageIntErr() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func TestEnum_AverageFloat64IsNaN(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := AverageFloat64(tt.args.source, tt.args.selector)
			want := math.IsNaN(got)
			if want != tt.want {
				t.Errorf("IsNaN(AverageFloat64()) = %v, want %v", want, tt.want)
			}
		})
	}
}
...
func TestEnum_AverageFloat64IsInf(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if want != tt.want {
				t.Errorf("IsInf(AverageFloat64()) = %v, want %v", want, tt.want)
			}
		})
	}
}
