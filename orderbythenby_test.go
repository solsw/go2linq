...
func Test_OrderByLsMust_int(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := OrderByLs(tt.args.source, tt.args.keySelector, tt.args.lesser).GetEnumerator()
...
func Test_OrderByLsMust_intint(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := Select(
				OrderByLs(tt.args.source, tt.args.keySelector, tt.args.lesser).GetEnumerator(),
...
func Test_OrderByLsDescendingMust_intint(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := Select(
				OrderByDescendingLs(tt.args.source, tt.args.keySelector, tt.args.lesser).GetEnumerator(),
				func(e elel[int]) int { return e.e1 },
			)
			if !SequenceEqual(got, tt.want) {
				got.Reset()
...
func Test_ThenByLsMust_1(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got1 := ThenByLs(tt.args.oe, tt.args.keySelector, tt.args.lesser).GetEnumerator()
			got2 := Select(got1, func(e elelel[int]) int { return e.e1 })
			if !SequenceEqual(got2, tt.want) {
				got2.Reset()
				tt.want.Reset()
...
func Test_ThenByLsMust_2(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "SecondOrderingIsUsedWhenPrimariesAreEqual",
			args: args{
				oe: OrderByLs(NewOnSlice(elelel[int]{1, 10, 22}, elelel[int]{2, 12, 21}, elelel[int]{3, 10, 20}),
					func(e elelel[int]) int { return e.e2 },
					IntLesser,
				),
				keySelector: func(e elelel[int]) int { return e.e3 },
...
func Test_ThenByLsMust_3(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got1 := ThenByLs(tt.args.oe, tt.args.keySelector, tt.args.lesser).GetEnumerator()
			got2 := Select(got1, func(e elelelel[int]) int { return e.e1 })
			if !SequenceEqual(got2, tt.want) {
				got2.Reset()
				tt.want.Reset()
				t.Errorf("ThenByLs() = '%v', want '%v'", String(got2), String(tt.want))
...
func Test_ThenByLsDescendingMust_1(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got1 := ThenByDescendingLs(tt.args.oe, tt.args.keySelector, tt.args.lesser).GetEnumerator()
			got2 := Select(got1, func(e elelel[int]) int { return e.e1 })
			if !SequenceEqual(got2, tt.want) {
				got2.Reset()
				tt.want.Reset()
